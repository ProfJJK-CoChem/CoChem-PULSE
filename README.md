# CoChem-PULSE: Laser and Coherent Control
...
Simulates molecule-field interactions and pulse shaping.
...
Solves the time-dependent Schrödinger equation (TDSE) explicitly for molecules subjected to arbitrary external oscillating electric fields.
...
```bash
cochem-pulse --field intense_ir.json
```
...
pipeline.run(target_module="CoChem-PULSE")
```
